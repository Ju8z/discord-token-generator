...
class EmailKopeechka:
    ...
    def __init__(self, emailAPI) -> None:
        ...
        response = requests.get(
            'https://api.kopeechka.store/mailbox-get-email?api=2.0&spa=1&site=discord.com&sender=discord&regex=&mail_type=&token=' + self.emailAPI).json()
